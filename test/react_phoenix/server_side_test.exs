defmodule ReactPhoenix.ServerSideTest do
  ...
  test "react_component returns a map with html" do
    assert %{"html" => _} = react_component("hello")
  end

  test "react_component returns an html string" do
    %{"html" => html} = react_component("hello")
  ...
  test "react_component accepts props and the component utilizes them" do
    %{"html" => html} = react_component("hello", %{name: "React"})
